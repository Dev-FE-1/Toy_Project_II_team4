...
import { SalaryDataItem, fetchSalaryDetails } from "../../api/salary/SalaryInfo";
...
export default function SalaryDetail() {
    ...
    const userId = "sajo1234567"; // 실제 사용자 ID로 대체 필요

    const { data, error, isLoading } = useQuery({
        queryKey: ['salaryDetails', 'employees'],
    ...
    if (!salaryData) {
        return <div>해당 급여 명세서가 없습니다.</div>;
    }
